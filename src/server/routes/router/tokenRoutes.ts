...
import { get as otherUserSkillsGet } from '@handler/user/other/skills/skills.js';
...
tokenRouter.get('/user/other/skills/:id', otherUserSkillsGet());
tokenRouter.patch('/user', userPatch());
tokenRouter.delete('/user', userDelete());
